package com.macojia.leanproduct.constant;
...
public class AppConstant {
    ...
    /*管控*/
    public static final String CONTROL_ITEMS = "CONTROL_ITEMS";
    public static final String QUALITY_ITEM = "质量指标";
    public static final String EFFICIENCY_ITEM = "效率指标";
    public static final String YIELD_ITEM = "产量指标";
    public static final String CONSUME_ITEM = "消耗指标";
    public static final String COMPREHENSIVE_ITEM = "综合指标";
    public static final String FEEDBACK_ITEM = "质量反馈";
    public static final String REPAIR_ITEM = "维修指导";
    public static final String FORECAST_ITEM = "进度预测";
