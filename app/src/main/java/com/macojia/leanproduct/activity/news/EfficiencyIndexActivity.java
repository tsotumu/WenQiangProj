 ...
 * on 2016.09.11:51
 */
public class EfficiencyIndexActivity extends BaseActivity<NewsChanelPresenter, NewsChannelModel>implements NewsChannelContract.View{
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    ...
    public static void startAction(Context context){
        Intent intent = new Intent(context, EfficiencyIndexActivity.class);
