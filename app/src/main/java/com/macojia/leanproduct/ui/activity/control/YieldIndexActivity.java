...
public class YieldIndexActivity extends BaseActivity {
    ...
    com.github.mikephil.charting.charts.HorizontalBarChart mBarChart;

    @Override
    public void initView() {
        mBarChart = (HorizontalBarChart) findViewById(R.id.view_chart);
        setPageTitle(R.string.control_yield_index);
